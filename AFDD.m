...
%  * Nmodes: number of modes to be identified
...
%  * LB: [1 x Nmodes]: float: option for selectin the lower boundary for cut-off frequency
%  * UB: [1 x Nmodes]: float: option for selectin the uper boundaty for cut-off frequency
% 
%% Output
